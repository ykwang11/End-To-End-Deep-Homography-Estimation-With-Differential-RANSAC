...
def transformer(U, theta, out_size, name='SpatialTransformer', **kwargs):
    ...
    def _transform(theta, input_dim, out_size, scale_h):
        with tf.variable_scope('_transform'):
            ...
            theta = tf.reshape(theta, (-1, 3, 3)) # Homagraphy is a 3x3 matrix
            theta = tf.cast(theta, 'float32')

            # NOTE Added: add two matrices M and B defined as follows in 
            ...
            # The problem may be here as a general homography does not preserve the parallelism 
